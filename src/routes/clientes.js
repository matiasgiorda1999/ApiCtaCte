...
router.post('/clientes',(req,res) => {
    ...
    const sqlQuery = `INSERT INTO clientes VALUES(${NroCtaCte}, ${Nombre}, ${PersonaJuridica}, ${CategoriaId}, ${SeccionId}, 
...
router.put('/clientes/:clienteid',(req,res) => {
    ...
    const sqlQuery = `UPDATE clientes SET NroCtaCte=${NroCtaCte}, Nombre=${Nombre}, PersonaJuridica=${PersonaJuridica}, 
